...
import GenArticleInteraction from '../components/GenArticleInteraction';
import { supabase } from '../client';
import { Link } from 'react-router-dom';
import Loading from '../components/Loading';

export default function GenReadArticle() {
        ...
        <>
            <MainLayout>
                <div className="view-recipe">
                    <Container>
                        <Link to="/child-health">{'< Back'}</Link>
                        <h1>{article.title}</h1>
                        ...
                        <GenArticleInteraction id={article.id}/>
                    </Container>
                </div>
            </MainLayout>
        </>
